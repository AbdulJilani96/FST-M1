...
public class RestAssuredGit {
    ...
    String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIA3yQFUw9yIGGgSNDX7n8mtkxT15VU69xtIOdjdgx3nE";

    int sshKeyId;

    RequestSpecification requestSpec = new RequestSpecBuilder()
            .setBaseUri("https://api.github.com/user/keys")
            .addHeader("Authorization","token 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")
